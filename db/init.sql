...
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO card_service;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO card_service;
